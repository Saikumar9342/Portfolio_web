                ...
                <div className="max-w-7xl mx-auto text-center relative z-10 w-full">
                    ...
                    >
                        <div className="inline-block px-4 py-1.5 rounded-full bg-[#C6A969]/10 border border-[#C6A969]/20 mb-4">
                            <Typography className="text-[10px] font-outfit font-bold tracking-widest text-[#C6A969] uppercase leading-none">
                                The Developer&apos;s Ecosystem
                            </Typography>
                        </div>

                        <Typography element="h1" className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-outfit font-bold tracking-tight uppercase leading-tight max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 px-4">
                            <Button size="lg" variant="ghost" className="w-full sm:w-auto h-11 px-8 rounded-xl text-white hover:bg-white/5 transition-all font-outfit uppercase tracking-widest text-[10px] font-bold border border-white/5">
                                Live Showcase
                            </Button>
                        </div>
                    </motion.div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-1/2 space-y-8">
                            <div className="space-y-4 text-center lg:text-left">
                                <Typography className="text-[#C6A969] font-bold tracking-[0.3em] text-[9px] uppercase">The Workflow</Typography>
                                <Typography element="h2" className="text-3xl md:text-5xl font-outfit font-bold tracking-tight uppercase leading-tight">The Atom <br /><span className="text-white/30 italic">Protocol</span></Typography>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="relative w-full max-w-[260px] h-[520px] bg-[#111111] rounded-[2.5rem] border-[4px] border-white/10 shadow-2xl p-4 overflow-hidden">
                                ...
                                <div className="space-y-6 px-2">
                                    <div className="h-20 w-full bg-white/[0.03] rounded-xl border border-white/5 p-3 flex flex-col justify-between">
                                        <Typography className="text-[7px] font-bold text-white/40 uppercase tracking-widest">Network Edge</Typography>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="h-16 bg-white/[0.03] rounded-xl border border-white/5 p-3 space-y-1">
                                            ...
                                            <Typography className="text-[12px] font-bold text-white">1.2k</Typography>
                                        </div>
                                        <div className="h-16 bg-white/[0.03] rounded-xl border border-white/5 p-3 space-y-1">
                                            <Zap className="w-3 h-3 text-[#C6A969]" />
                                            <Typography className="text-[12px] font-bold text-white">99.9%</Typography>
                                        </div>
                                    </div>
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="order-1 lg:order-2 space-y-8">
                            <div className="space-y-4">
                                <Typography className="text-[#C6A969] font-bold tracking-[0.3em] text-[10px] uppercase">The Gateway</Typography>
                                <Typography element="h2" className="text-4xl md:text-5xl lg:text-6xl font-outfit font-bold tracking-tight uppercase leading-tight">Atom <span className="text-white/30">Mobile</span></Typography>
                                <Typography className="text-sm text-[#AAAAAA] max-w-sm leading-relaxed italic text-center lg:text-left mx-auto lg:mx-0">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    ...
                                    <div key={i} className="space-y-2">
                                        ...
                                        <Typography element="h4" className="text-xs font-outfit font-bold uppercase text-white tracking-widest">{feature.title}</Typography>
                            ...
                            <div className="pt-4 flex justify-center lg:justify-start">
                                <div className="inline-flex flex-col items-center lg:items-start">
                                    <Typography className="text-[8px] font-bold tracking-widest text-[#C6A969] uppercase mb-4">Availability</Typography>
                                    <div className="h-10 px-4 rounded-xl border border-white/10 bg-white/[0.02] flex items-center gap-3 grayscale opacity-30">
                                        <Typography className="text-[9px] font-bold uppercase tracking-widest">Awaiting Store Approval</Typography>
                                    </div>
            ...
            <section id="features" className="relative min-h-[800px] flex items-center justify-center px-6 snap-start border-t border-white/5 bg-[#0A0A0A] py-24">
                ...
                <div className="max-w-7xl mx-auto w-full relative z-10">
                    <div className="text-center mb-16 space-y-4">
                        <Typography className="text-[#C6A969] font-bold tracking-widest text-[10px] uppercase">The Arsenal</Typography>
                        <Typography element="h2" className="text-3xl md:text-5xl font-outfit font-bold tracking-tight uppercase leading-tight">
            ...
            <section className="relative h-screen min-h-[600px] flex items-center justify-center px-6 snap-start bg-[#050505] border-t border-white/5 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto w-full relative z-10 text-center space-y-12">
                    <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1 }}>
                        ...
                        <Typography element="h2" className="text-2xl md:text-4xl lg:text-5xl font-outfit font-bold tracking-tight uppercase leading-relaxed text-white">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3, duration: 0.8 }} className="flex flex-col items-center">
                        <div className="flex gap-4 items-center">
                            ...
                            <Typography className="text-[10px] font-bold text-white/40 uppercase tracking-widest">The Philosophy</Typography>
                            <div className="w-12 h-px bg-white/20" />
                        </div>
                    </motion.div>
                </div>
            ...
            <section id="architect" className="relative min-h-[600px] flex items-center justify-center px-6 snap-start border-t border-white/5 bg-[#080808]">
                <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col items-center text-center">
                    <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
                        ...
                        <Typography className="text-[#C6A969] font-bold tracking-widest text-[10px] uppercase mb-4">The Architect</Typography>
                        <Typography element="h2" className="text-2xl md:text-4xl lg:text-5xl font-outfit font-bold tracking-tight uppercase leading-none mb-6">
                ...
                <div className="max-w-7xl mx-auto w-full relative z-10 flex-1 flex flex-col items-center justify-center">
                    <div className="text-center mb-12">
                        <motion.div initial={{ opacity: 0, y: -5 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                            ...
                            <Typography element="h2" className="text-3xl md:text-5xl font-outfit font-bold tracking-tight uppercase leading-none">
                        ...
                        {[
                            ...
                            >
                                <div className="p-5 rounded-xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.05] transition-all group flex flex-col items-center text-center">
                                    ...
                                    <Typography className="text-[11px] font-outfit font-bold text-white/90 uppercase mb-1 tracking-tight">{tech.title}</Typography>
                    ...
                    <footer className="pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                        <div className="flex items-center gap-8">
                            <div className="flex items-center gap-2">
                                ...
                                <Typography className="text-[10px] font-bold text-white uppercase tracking-tight">ATOM ECOSYSTEM</Typography>
                            </div>
                            <Link href="https://saikumar.is-a.dev/" target="_blank">
